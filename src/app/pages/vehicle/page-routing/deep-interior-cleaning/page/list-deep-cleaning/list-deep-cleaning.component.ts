...
@Component({
  selector: 'app-list-deep-cleaning',
  standalone: true,
  imports: [
        CommonModule,
            FormsModule,
  ...
  templateUrl: './list-deep-cleaning.component.html',
  styleUrl: './list-deep-cleaning.component.scss'
})
export class ListDeepCleaningComponent implements OnInit{
    ...
    routerDetail(id: any){
      this.routes.navigate(['/vehicle/detail-deep-cleaning/', id])
    }
}
