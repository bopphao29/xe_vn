...
import { ChildReportComponent } from './report-dcl-child/child-report/child-report.component';

@Component({
  selector: 'app-detail-report-dcl',
  standalone: true,
  imports: [
        CommonModule,
        FormsModule,
  ...
  templateUrl: './detail-report-dcl.component.html',
  styleUrl: './detail-report-dcl.component.scss'
})
export class DetailReportDclComponent implements OnInit{
